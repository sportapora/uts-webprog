                                ...
                                <td class="px-6 py-4">
                                    <div class="flex">
                                        <a href="/admin/events/detail.php?id=<?= $events['id'] ?>"
                                           class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Detail</a>

                                        <a href="/admin/events/edit.php?id=<?= $events['id'] ?>"
                                           class="focus:outline-none inline-block text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Edit</a>
                                        <form action="/admin/process/delete_event.php" method="post" class="inline-block">
