            ...
            <div class="rounded-lg shadow-lg dark:bg-gray-600 p-6 mt-10">
                ...
                <div class="flex flex-col lg:flex-row gap-6 mt-10">
                    <div class="w-full lg:w-1/2">
                        <p>Gambar event</p>
                        <img src="../../assets/events/gambar/<?= $event['gambar'] ?>" class="w-[200px] rounded-md mt-4" alt="<?= $event['nama'] ?>">
                    </div>
                    <div class="w-full lg:w-1/2">
                        <p>Banner event</p>
                        <img src="../../assets/events/banner/<?= $event['banner'] ?>" class="w-[200px] rounded-md mt-4" alt="<?= $event['nama'] ?>">
                    </div>
                </div>
            </div>
        </div>
