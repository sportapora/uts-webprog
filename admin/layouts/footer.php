...
<footer class="bg-gray-800">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/admin" class="hover:underline font-semibold" id="logo">Festivo!</a>. All Rights Reserved.
    </span>
        <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            <li>
                <a href="/admin" class="hover:underline me-4 md:me-6">Home</a>
            </li>
            <li>
                <a href="/admin/events" class="hover:underline me-4 md:me-6">Events</a>
            </li>
            <li>
                <a href="/admin/users" class="hover:underline me-4 md:me-6">Users</a>
            </li>
        </ul>
    </div>
</footer>
