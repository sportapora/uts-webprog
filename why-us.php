...
<div class="flex flex-col justify-center items-center min-h-screen p-4" style="background-image: url('/assets/group.jpg');background-repeat: no-repeat;background-size: cover; background-position: center">
    <div class="flex flex-col xl:flex-row gap-12 items-center xl:items-start px-20">
        <div class="flex-grow text-center xl:text-left space-y-4 mt-20 lg:mt-0">
            <p class="text-white text-5xl xl:text-7xl font-medium">WHY</p>
            <span class="block text-7xl xl:text-9xl text-blue-700">
                <span class="font-bold" id="logo">Festivo!</span><span class="text-white">?</span>
            </span>
            <p class="text-white text-2xl xl:text-4xl">Your ultimate event management platform</p>
        </div>
        <div class="flex flex-col justify-evenly text-center space-y-8">
            <div class="text-center">
                <p class="text-white font-bold text-xl xl:text-2xl mb-3">Manajemen Acara Tanpa Ribet</p>
                <p class="text-white font-medium text-sm xl:text-base text-balance">Atur Acara Anda dengan Mudah dan Efisien
            ...
            <div class="text-center">
                <p class="text-white font-bold text-xl xl:text-2xl mb-3">Terhubung dengan Peserta</p>
                <p class="text-white font-medium text-sm xl:text-base text-balance">Bangun Koneksi yang Kuat dan Berkelanjutan
            ...
            <div class="text-center">
                <p class="text-white font-bold text-xl xl:text-2xl mb-3">Promosi Mudah</p>
                <p class="text-white font-medium text-sm xl:text-base text-balance">Promosikan Acara Anda dengan Sederhana dan Efektif
    ...
    <div class="p-14 text-center">
        <a href="index.php" class="text-2xl text-white font-extrabold xl:text-4xl hover:text-blue-700">Ready to host your next event?</a>
    </div>
</div>
