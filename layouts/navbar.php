                ...
                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button"
                        ...
                        <div class="w-8 h-8 bg-blue-500 text-white flex items-center justify-center rounded-full">
                            <span class="text-sm"><?php echo substr($_SESSION['user']['username'], 0, 1); ?></span>
                        </div>
                    </button>
                    <!-- Dropdown menu -->
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow"
                        ...
                        <div class="px-4 py-3">
                            <a href="/user/profile.php">
                                <span class="block text-sm text-gray-900"><?php echo $_SESSION['user']['username']; ?></span>
                                <span class="block text-sm text-gray-500 truncate"><?php echo $_SESSION['user']['email']; ?></span>
                            </a>
                        </div>
